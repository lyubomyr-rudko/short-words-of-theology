...
const usage = `Usage:
  npm run marp:pdf -- <slides.md> [output.pdf]
  node scripts/export-marp-pdf.mjs <slides.md> [output.pdf]

Examples:
  npm run marp:pdf -- lesson-53-on-valuing-our-neibour.slides.md
  npm run marp:pdf -- lesson-53-on-valuing-our-neibour.slides.md exports/lesson-53.pdf
